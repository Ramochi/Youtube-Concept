const myChannleSlider = new Swiper('.my-channel-slider',{
  // Optional parameters
  loop: true,
  slidesPerView: 1,
  spaceBetween: 20,
...
const recommendedChannleSlider = new Swiper('.recommended-channel-slider',{
  // Optional parameters
  loop: true,
  slidesPerView: 1,
  spaceBetween: 20,
...
if (document.documentElement.scrollWidth <= 640) {
  myChannleSlider.destroy();
  recommendedSlider.destroy();
  recommendedChannleSlider.destroy();
}